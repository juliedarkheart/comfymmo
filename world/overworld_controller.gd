...
func _spawn_village_content(player: AvatarController) -> void:
	...
	interactable_system.register_interactable("ow_maribel", maribel, "villager", "Press F to talk to Maribel")
	...
	interactable_system.register_interactable("ow_bram", bram, "villager", "Press F to talk to Bram")
	...
	interactable_system.register_interactable("ow_notice", notice, "notice_board", "Press F to read notice board")
	...
	interactable_system.register_interactable("ow_village_rabbit", rabbit, "ambient_creature", "Press F to observe")
...
func _spawn_forest_content(player: AvatarController) -> void:
	...
	interactable_system.register_interactable("ow_shrine", shrine, "shrine_marker", "Press F to inspect shrine")
	...
	for i in range(rabbit_positions.size()):
		...
		interactable_system.register_interactable(rabbit_id, rabbit, "ambient_creature", "Press F to observe")
